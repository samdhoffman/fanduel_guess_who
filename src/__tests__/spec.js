...
// import { functions } from './stateFunctions';
import { render, cleanup } from '@testing-library/react';
import axios from 'axios';
import Players from '../components/Players';
import PlayerCard from '../components/PlayerCard';
import { findByTestAttr } from '../../utils';
// import { loadPlayerData, URL } from '../components/Players';
...
const setup = (props={}) => {
  const component = shallow(<Players {...props} />);
  return component;
}
...
describe("Players component", () => {
  ...
  it("should render without errors", () => {
    const wrapper = findByTestAttr(component, "Players");
  ...
  // describe("when there is no player data", () => {
